...
\begin{itemize}
\item \textbf{RQ1:} How do predictions change with transformation family and severity?
\item \textbf{RQ2:} What different behaviors are revealed by prediction stability and representation stability?
\item \textbf{RQ3:} Does representation information improve failure detection when added to the specified output/confidence features?
